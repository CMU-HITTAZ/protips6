 ...
 * on 2014-03-27 at 05:58:55 UTC 
 * Modify at your own risk.
 */

package com.protips6.entity.quoteendpoint;
...
public class Quoteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * and normally should not be changed. https://precise-data-511.appspot.com/_ah/api/
   *
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://precise-data-511.appspot.com/_ah/api/";
  ...
  public class GetQuote extends QuoteendpointRequest<com.protips6.entity.quoteendpoint.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.protips6.entity.quoteendpoint.model.Quote.class);
   ...
   * operation.
   *
   * @param content the {@link com.protips5.entity.quoteendpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.protips6.entity.quoteendpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteendpointRequest<com.protips6.entity.quoteendpoint.model.Quote> {
     ...
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link com.protips6.entity.quoteendpoint.model.Quote}
     * @since 1.13
     */
    protected InsertQuote(com.protips6.entity.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "POST", REST_PATH, content, com.protips6.entity.quoteendpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteendpointRequest<com.protips6.entity.quoteendpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.protips6.entity.quoteendpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.protips6.entity.quoteendpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteendpointRequest<com.protips6.entity.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.protips6.entity.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "PUT", REST_PATH, content, com.protips6.entity.quoteendpoint.model.Quote.class);
    }
